...
public class AuthenticationStepDefinitions {
    ...
    @Given("^that Ricardo wants to enter the Wordpress application$")
    public void thatRicardoWantsToEnterTheWordpressApplication() {
        OnStage.theActorCalled("Ricardo").wasAbleTo(OpenThe.wordpressApp());
